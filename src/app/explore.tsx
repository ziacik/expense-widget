			...
			<ThemedView style={styles.container}>
				...
				<ThemedView style={styles.sectionsWrapper}>
					...
					<Collapsible title="Images">
						<ThemedText type="small">
							For static images, you can use the <ThemedText type="code">@2x</ThemedText> and <ThemedText type="code">@3x</ThemedText> suffixes to
					...
					<Collapsible title="Light and dark mode components">
						<ThemedText type="small">
							This template has light and dark mode support. The <ThemedText type="code">useColorScheme()</ThemedText> hook lets you inspect what
